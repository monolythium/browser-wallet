...
export function WalletLockLogo({ size = 56 }: WalletLockLogoProps) {
  ...
  return (
    ...
    >
      ...
      {/* Lock badge — bottom-right corner, slightly overlapping the squircle.
         Fill is the logo's exact accent (var(--gold)); a 2px ring in the page
         background (var(--ink-000)) separates it from the squircle. The
         padlock glyph uses the brand near-white text token (var(--fg-100)). */}
      <div
        style={{
          position: "absolute",
          right: -2,
