...
- Authenticates to supported web apps through the origin-bound **`monolythium_authenticate`** provider method, with an explicit wallet approval for every request.
